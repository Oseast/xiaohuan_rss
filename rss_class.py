...
class Rss:
    def __init__(self, **kwargs):
        ...
        # 更新实例的 __dict__ 属性以包含所有传入的关键字参数
    ...
    def delete_user(self, user: str) -> bool:
        ...
        with TinyDB(
            ...
            db.update(tinydb_set("user_id", self.user_id), Query().name == self.name)  # type: ignore
        return True
